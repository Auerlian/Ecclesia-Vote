...
/**
 * The active ballot engine for this deployment. v0.1 = MockEngine (PROTOTYPE). The footer's
 * security notice (app/layout.tsx) is keyed off this value, so swapping to a v0.2
