...
function Lesson({
  ...
  return (
    <div className="card card-hover overflow-hidden p-0">
      <div className={`flex items-center gap-3 px-5 py-3 text-white ${color}`}>
...
export default function HowItWorks() {
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <header className="card flex items-center gap-5 overflow-hidden">
        ...
        <div>
          <h1 className="text-2xl font-black tracking-tight text-ink">
            Tiny lessons in trustworthy voting
          </h1>
          <p className="mt-1 text-sm font-semibold text-ink/55">
            Three checks make an election trustworthy. Each takes about a minute to understand — and
            none of them require trusting us.
          </p>
        </div>
      </header>
      ...
      <Lesson
        n={1}
        title="Did my ballot get counted?"
        emoji="🧾"
        color="bg-gradient-to-r from-royal-500 to-royal-600"
      >
        <p>
          When you cast, you <strong className="text-ink">build your own receipt</strong> — picking
        ...
        <p>
          ...
          from your choice, so even if someone forces you to reveal it, it only ever says “this
          ballot exists” — never how you voted.
        </p>
      </Lesson>

      <Lesson
        n={2}
        title="Was my ballot encrypted correctly?"
        emoji="🕵️"
        color="bg-gradient-to-r from-coral-500 to-blush-500"
      >
        <p>
      ...
      <Lesson
        n={3}
        title="Was the final tally honest?"
        emoji="🧮"
        color="bg-gradient-to-r from-mint-500 to-royal-500"
      >
        <p>
          After the vote closes, anyone can download the audit bundle and run the standalone{" "}
          <code className="rounded bg-mint-50 px-1.5 py-0.5 font-mono text-xs">
            ecclesia-verify
          </code>{" "}
          tool. It re-walks the audit log's hash chain, recomputes every ballot hash, and recomputes
          the tally — with no access to our servers.
        </p>
        <p>
      ...
      <div className="card border-2 border-dashed border-sunshine-300 bg-sunshine-50">
        <h2 className="text-base font-black text-ink">What this prototype does NOT yet do ⚠️</h2>
      ...
      <div className="card bg-gradient-to-br from-royal-500 to-grape-600 text-center text-white">
        <h2 className="text-lg font-black">Best way to learn it? Do it.</h2>
